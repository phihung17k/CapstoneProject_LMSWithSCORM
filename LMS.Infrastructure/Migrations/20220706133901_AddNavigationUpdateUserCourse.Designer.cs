...
namespace LMS.Infrastructure.Migrations
{
    ...
    [Migration("20220706133901_AddNavigationUpdateUserCourse")]
    partial class AddNavigationUpdateUserCourse
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Data.Entity.OtherLearningResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.OtherLearningResourceTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.QuizQuestion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LMS.Data.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTimeOffset(new DateTime(2022, 7, 6, 20, 39, 0, 280, DateTimeKind.Unspecified).AddTicks(1382), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreateTime = new DateTimeOffset(new DateTime(2022, 7, 6, 20, 39, 0, 284, DateTimeKind.Unspecified).AddTicks(1331), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Student"
                        });
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMCommentFromLearner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMCommentFromLms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMCore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMInteraction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMInteractionCorrectResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMInteractionObjective", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMLearnerPreference", b =>
                {
                    b.Property<int>("SCORMCoreId")
                        .HasColumnType("integer")
                        .HasColumnName("scorm_core_id");
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMNavigation", b =>
                {
                    b.Property<int>("SCORMCoreId")
                        .HasColumnType("integer")
                        .HasColumnName("scorm_core_id");
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMObjective", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.TopicOtherLearningResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.TopicSCORM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.UserSurveyDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LMS.Data.Entity.OtherLearningResourceTracking", b =>
                {
                    ...
                    b.HasOne("LMS.Data.Entity.TopicOtherLearningResource", "TopicOtherLearningResource")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMCommentFromLearner", b =>
                {
                    b.HasOne("LMS.Data.Entity.SCORMCore", "SCORMCore")
                        .WithMany()
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMCore", b =>
                {
                    ...
                    b.HasOne("LMS.Data.Entity.TopicSCORM", "TopicSCORM")
                        .WithMany("SCORMCores")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMInteractionCorrectResponse", b =>
                {
                    b.HasOne("LMS.Data.Entity.SCORMInteraction", "SCORMInteraction")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMLearnerPreference", b =>
                {
                    b.HasOne("LMS.Data.Entity.SCORMCore", "SCORMCore")
                        ...
                        .HasForeignKey("LMS.Data.Entity.SCORMLearnerPreference", "SCORMCoreId")
            ...
            modelBuilder.Entity("LMS.Data.Entity.SCORMNavigation", b =>
                {
                    b.HasOne("LMS.Data.Entity.SCORMCore", "SCORMCore")
                        .WithOne("Navigation")
                        .HasForeignKey("LMS.Data.Entity.SCORMNavigation", "SCORMCoreId")
            ...
            modelBuilder.Entity("LMS.Data.Entity.TopicOtherLearningResource", b =>
                {
                    b.HasOne("LMS.Data.Entity.OtherLearningResource", "OtherLearningResource")
            ...
            modelBuilder.Entity("LMS.Data.Entity.TopicSCORM", b =>
                {
                    b.HasOne("LMS.Data.Entity.SCORM", "SCORM")
            ...
            modelBuilder.Entity("LMS.Data.Entity.UserSurveyDetail", b =>
                {
                    b.HasOne("LMS.Data.Entity.SurveyOption", "SurveyOption")
                        .WithMany()
                    ...
                    b.HasOne("LMS.Data.Entity.UserSurvey", "UserSurvey")
                        .WithMany()
