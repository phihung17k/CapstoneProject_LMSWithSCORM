...
namespace LMS.Infrastructure.Migrations
{
    ...
    [Migration("20220620112917_AddActiveDelete")]
    partial class AddActiveDelete
    {
            ...
            modelBuilder.Entity("LMS.Data.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTimeOffset(new DateTime(2022, 6, 20, 18, 29, 16, 167, DateTimeKind.Unspecified).AddTicks(4312), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreateTime = new DateTimeOffset(new DateTime(2022, 6, 20, 18, 29, 16, 170, DateTimeKind.Unspecified).AddTicks(2713), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Student"
                        });
