...
namespace LMS.Infrastructure.Migrations
{
    ...
    [Migration("20220620101244_AdjustEntity")]
            ...
            modelBuilder.Entity("LMS.Data.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTimeOffset(new DateTime(2022, 6, 20, 17, 12, 44, 81, DateTimeKind.Unspecified).AddTicks(2574), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreateTime = new DateTimeOffset(new DateTime(2022, 6, 20, 17, 12, 44, 83, DateTimeKind.Unspecified).AddTicks(6513), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Student"
                        });
